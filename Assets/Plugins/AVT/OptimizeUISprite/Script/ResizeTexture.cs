...
{
    private const string pluginFolderPath = "Auto/Resize/";
    ...
    private static bool IsAutoTrim
    {
        ...
        set
        {
            ...
            Menu.SetChecked(pluginFolderPath + "Is Auto Trim", value);
        }
    }

    #region Menu Item

    [MenuItem(pluginFolderPath + "Is Auto Trim", priority = -100)]
    ...
    [MenuItem("Auto/Resize/ResizeTextureToDiv4 &e", false, -101)]
