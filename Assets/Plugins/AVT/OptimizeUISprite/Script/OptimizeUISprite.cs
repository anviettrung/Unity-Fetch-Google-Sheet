...
public static class OptimizeUISprite
{
    ...
    private const string pluginFolderPath = "Auto/Optimize Sprite/";
    private const string hotkeyOptimizeSprite9Slices = " &q";
    ...
    [MenuItem(pluginFolderPath + "9-Slices" + hotkeyOptimizeSprite9Slices)]
